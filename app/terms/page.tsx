    ...
    <>
      ...
      <main className="max-w-2xl mx-auto px-4 py-10 pb-28 sm:pb-10">
        ...
        <div className="neu-card p-6 sm:p-8 prose prose-sm text-muted-foreground space-y-4">
          ...
          <h2 className="text-base font-bold text-foreground mt-6">Prohibited Items</h2>
          <p>You may not list stolen goods, counterfeit products, weapons, drugs, or any items prohibited by Ugandan law.</p>
          <h2 className="text-base font-bold text-foreground mt-6">Listing Accuracy</h2>
          <p>Sellers are responsible for accurate descriptions of their items. Misrepresentation may result in account suspension.</p>
          <h2 className="text-base font-bold text-foreground mt-6">Limitation of Liability</h2>
