...
export default function SellToUsPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    window.open(`https://wa.me/256767155113?text=${msg}`, "_blank");
    setSubmitted(true);
  }
          ...
          <div className="max-w-3xl mx-auto">
            <div className="neu-dark-card text-foreground py-12 px-6 text-center">
              ...
              <p className="text-muted-foreground text-base max-w-xl mx-auto mb-6">
                Send us your item — phone, TV, laptop, appliance, or anything.
                We'll review it and send you a cash offer on WhatsApp, usually
                within a day.
              </p>
        ...
        {submitted ? (
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground mb-6">
              We've received your item details via WhatsApp. Expect a cash offer
              within 24 hours.
            </p>
            <button
          ...
          <>
            <ScrollReveal>
              <h2 className="font-heading text-xl font-extrabold text-foreground mb-6 text-center">
              ...
              <ScrollReveal delay={100} className="lg:col-span-3">
                ...
                >
                  ...
                  <div className="bg-secondary/10 border border-secondary/40 rounded-xl p-3 text-xs text-secondary">
                    📸 <strong>Tip:</strong> After submitting, send clear photos
                    of your item on WhatsApp for a faster and more accurate
                    offer.
                  </div>
              ...
              <ScrollReveal delay={100} className="lg:col-span-2">
                <div className="space-y-3">
                  ...
                  {[
                    {
                      n: "1",
                      title: "Submit your item details",
                      desc: "Fill the form above with your item info and contact number.",
                    },
                    {
                      n: "2",
                      title: "We review & respond",
                      desc: "Our team evaluates your item and sends a cash offer on WhatsApp within 24 hours.",
                    },
                    {
                      n: "3",
                      title: "Get paid",
                      desc: "Accept the offer, bring your item to us in Kitoro, Entebbe and receive instant cash payment.",
                    },
                  ].map((step) => (
                    <div
                      key={step.n}
                      className="neu-card flex items-start gap-4 p-4"
                    >
