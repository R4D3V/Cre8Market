...
export const metadata: Metadata = {
  title: "Daily Deals & Discounts in Entebbe",
  description:
    "Browse today’s best deals on phones, laptops, electronics, and household items in Entebbe.",
  alternates: {
    canonical: "/deals",
  },
};
          ...
          <div className="max-w-7xl mx-auto">
            <div className="neu-dark-card text-foreground py-10 px-6 text-center">
              ...
              <p className="text-muted-foreground text-sm max-w-md mx-auto">
                The best prices on electronics, phones, laptops and more in
                Uganda — refreshed every day.
              </p>
            </div>
          </div>
        </div>
